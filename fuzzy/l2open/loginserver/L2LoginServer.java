...
//		final String LOG_NAME = "C:\\l2openX50\\java\\config\\log.properties"; // Name of log file
...
//		Shutdown.getInstance().startShutdownH(ConfigValue.AutoRestart, true);
	...
	private void loadProxy()
	{
		try
		{
            File file = new File(ConfigValue.DatapackRoot + "./gameservers.xml");
//            File file = new File("gameservers.xml");
