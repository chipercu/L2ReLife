...
import l2open.gameserver.model.L2ObjectTasks.RandomAnimationTask;
import l2open.gameserver.model.L2Zone.ZoneType;
import l2open.gameserver.model.barahlo.CertificationFunctions;
...
import l2open.gameserver.tables.TeleportTable.TeleportLocation;
...
public class L2NpcInstance extends L2Character implements HTML_Generator {
    ...
    public void set_spawnedLoc(Location _spawnedLoc) {
        this._spawnedLoc = _spawnedLoc;
    }
    ...
    static int[][] _mageBuff = new int[][]{
            ...
            {1, ConfigValue.BuffMaxLevel, 4322, 1}, // windwalk
            ...
            {1, ConfigValue.BuffMaxLevel, 4329, 1}, // acumen
