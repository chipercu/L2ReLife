...
import l2open.gameserver.taskmanager.DotTaskManager;
import l2open.gameserver.taskmanager.EffectTaskManager;
import l2open.util.ArrayMap;
...
public abstract class L2Effect
{
	...
	{
		if(getEffected().getSkillLevel(4045) > 0 &&
				(getSkill().getTraitType() == SkillTrait.trait_hold || getSkill().getTraitType() == SkillTrait.trait_sleep || getSkill().getTraitType() == SkillTrait.trait_derangement || getSkill().getTraitType() == SkillTrait.trait_paralyze || getSkill().getTraitType() == SkillTrait.trait_shock || getSkill().getTraitType() == SkillTrait.trait_boss || getSkill().getTraitType() == SkillTrait.trait_physical_blockade))
			return false;
		return true;
	}
