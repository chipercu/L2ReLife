...
public class AdminEditChar implements IAdminCommandHandler, ScriptFile
{
	...
	public static void showCharacterList(L2Player activeChar, L2Player player)
	{
		...
		StringBuffer replyMSG = new StringBuffer();
		{
			...
			replyMSG.append("<tr><td width=100>Reflect_Name:</td><td>" + player.getReflection().getName() + "</td></tr>");
			replyMSG.append("<tr><td width=100>Reflect_ID:</td><td>" + player.getReflection().getId() + "</td></tr>");
			replyMSG.append("</table><br>");
