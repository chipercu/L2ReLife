    ...
    public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, L2Player activeChar) {
        ...
        switch (command) {
            ...
            case admin_abnormal:
                ...
                break;
            case admin_abnormal_new: {
                activeChar.startAbnormalEffect(AbnormalVisualEffect.ave_vp_up);
                activeChar.sendMessage(String.valueOf(activeChar.getAbnormalEffect()));
