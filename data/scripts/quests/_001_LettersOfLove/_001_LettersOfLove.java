package scripts.quests._001_LettersOfLove.ru._001_LettersOfLove;
		...
		switch(npcId)
		{
			case DARIN:
				...
				else if(cond == 4 && st.getQuestItemsCount(BAULS_POTION) == 1)
				{
					...
					st.giveItems(ADENA_ID, (int) ((ConfigValue.RateQuestsRewardAdena - 1) * 1200 + 2466 * ConfigValue.RateQuestsRewardAdena), false); // T2
