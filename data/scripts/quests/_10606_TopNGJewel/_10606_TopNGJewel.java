package quests._10606_TopNGJewel;
...
public class _10606_TopNGJewel extends Quest implements ScriptFile {

    private static final String HTML_ROOT = "data/scripts/quests/_10606_TopNGJewel/";
    private static final String ManicheanDamage = "ManicheanDamage";


    private static final int StartNewbieGuide = 30598;
    ...
    private static final int TalkingMagSchoolGrandMaster = 30042;
    private static final int TalkingMagSchoolInstructor = 30042;

    private static final int TalkingSchoolManichean = 36636;



    private static final int Monster1 = 20343;
    private static final int Monster3 = 20342;
    private static final int Monster2 = 20132;
    ...
    private static final int[] MAG_SET_LOW = {41, 1100, 1103, 1119, 35, 9583};
    private static final int[] LIGHT_SET_LOW = {42, 22, 29, 1119, 36, };

    private static final int[] MAG_SET_TOP = {44, 1101, 1104, 50, 37};
    private static final int[] LIGHT_SET_TOP = {44, 24, 31, 50, 38};

    private static final int[] JEWEL_SET_LOW = {114,114, 906, 875, 875};
    private static final int[] JEWEL_SET_TOP = {846, 846, 909, 878, 878};

    private static final int HealingPotion = 1539;
    private static final int ManaPotion = 728;
    private static final int SoulShot = 1835;
    private static final int SpiritShot = 3947;
    private static final int Arrows = 17;





    public _10606_TopNGJewel()
    {
        super(PARTY_NONE);
        ...
        addTalkId(StartNewbieGuide, TalkingGrandMaster, TalkingWeaponMerchant, TalkingArmorMerchant, TalkingJewelMerchant,
                ...
                TalkingMagSchoolGrandMaster, TalkingMagSchoolInstructor);
    ...
    public String onEvent(String event, QuestState st, L2NpcInstance npc)
    {
        ...
        if (event.equalsIgnoreCase("EnterWorld")){
            ...
            return nextNpc(player, st.getCond());
        }else if(event.equalsIgnoreCase("TalkingGrandMaster_Accept")) {
            st.setCond(2);
            addRadarToNpc(player, getNpcByID(TalkingWeaponMerchant));
            return nextNpc(player, st.getCond());
        }else if(event.equalsIgnoreCase("give_weapon_sword")) {
            st.setCond(3);
            st.giveItems(SWORD_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(SWORD_WEAPON_LOW), true);
            ...
            st.setCond(3);
            st.giveItems(BOW_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(BOW_WEAPON_LOW), true);
            ...
            st.setCond(3);
            st.giveItems(DAGGER_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(DAGGER_WEAPON_LOW), true);
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[3] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            ...
            st.setCond(3);
            st.giveItems(MAG_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(MAG_WEAPON_LOW), true);
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[3] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            ...
            st.setCond(3);
            st.giveItems(FIST_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(FIST_WEAPON_LOW), true);
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[3] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            ...
            st.setCond(3);
            st.giveItems(BLUNT_WEAPON_LOW, 1);
            player.getInventory().equipItem(player.getInventory().getItemByItemId(BLUNT_WEAPON_LOW), true);
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[3] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            ...
            if (player.isMageClass()){
                ...
                if (player.getLevel() < 20){
                    long addexp = Experience.LEVEL[4] - player.getExp();
                    player.addExpAndSp(addexp, addexp / 5, false, false);
                }
            }else {
            ...
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[5] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            ...
            if (player.getLevel() < 20){
                long addexp = Experience.LEVEL[6] - player.getExp();
                player.addExpAndSp(addexp, addexp / 5, false, false);
            }
            addRadarToNpc(player, getNpcByID(TalkingGrandMaster));
            return nextNpc(player, st.getCond());
