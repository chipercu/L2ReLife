...
public class KetraRangerAI extends Ranger {
    ...
    public KetraRangerAI(L2Character actor) {
        super(actor);
    }
        ...
        public void runImpl() throws Exception {
            ...
            if (character != null) {
                if (character.isNpc()) {
                    ...
                    if (npcId == 36649 || npcId == 36648 || npcId == 36647 || character.isDead() || actor.getDistance(character) >= 1200 ) {
                        character = null;
                        stopAITask();
                        clearTasks();
                        clientStopMoving();
