...
//        s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":buycoffer " + 5 +"\" value=\"Заполнить сферу боевым опытом\" width=250 height=31 back=\"New_Buttons.Btn_Back\" fore=\"New_Buttons.Btn_Font\">");
        ...
        s.append("<tr>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26078 +"\" value=\"получить умение MP\" width=64 height=64 back=\"ReLifeBTN.bust_mp\" fore=\"ReLifeBTN.bust_mp\">");
            s.append("</td>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26079 +"\" value=\"получить умение HP\" width=64 height=64 back=\"ReLifeBTN.bust_hp\" fore=\"ReLifeBTN.bust_hp\">");
            s.append("</td>");
        s.append("</tr>");
        s.append("<tr>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26080 +"\" value=\"получить умение CP\" width=64 height=64 back=\"ReLifeBTN.bust_cp\" fore=\"ReLifeBTN.bust_cp\">");
            s.append("</td>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26081 +"\" value=\"получить умение Скорость Физ Атаки\" width=64 height=64 back=\"ReLifeBTN.speed_attack\" fore=\"ReLifeBTN.speed_attack\">");
            s.append("</td>");
        s.append("</tr>");
        s.append("<tr>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26082 +"\" value=\"получить умение Скорость Маг Атаки\" width=64 height=64 back=\"ReLifeBTN.speed_cast\" fore=\"ReLifeBTN.speed_cast\">");
            s.append("</td>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26083 +"\" value=\"получить умение Скорость Бега\" width=64 height=64 back=\"ReLifeBTN.speed_move\" fore=\"ReLifeBTN.speed_move\">");
            s.append("</td>");
        s.append("</tr>");
        s.append("<tr>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26084 +"\" value=\"получить умение Точность\" width=64 height=64 back=\"relife.accurancy\" fore=\"ReLifeBTN.accurancy\">");
            s.append("</td>");
            s.append("<td>");
                s.append("<button ALIGN=LEFT action=\"bypass -h scripts_events."+event_name+"."+event_name+":getSkill " + 26085 +"\" value=\"получить умение Уклонение\" width=64 height=64 back=\"relife.evassion\" fore=\"ReLifeBTN.evassion\">");
            s.append("</td>");
        s.append("</tr>");
        s.append("</table>");
        return s.toString();
