...
public class KetraGuardInstance extends L2MonsterInstance {

    public KetraGuardInstance(int objectId, L2NpcTemplate template) {
        super(objectId, template);
        //this.setAI(new KetraGuardAI(this));
    }
