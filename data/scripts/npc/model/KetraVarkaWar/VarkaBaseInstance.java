...
public class VarkaBaseInstance extends L2NpcInstance {
    ...
    private static final int[] guards = {36653, 36654, 36655, 36656, 36657};
    private static final int[] attackers = {36655, 36656, 36657};
    private static final int officerId = 36652;
    private static final int recruitId = 36650;
    private static final int footmanId = 36651;
    ...
    public VarkaBaseInstance(int objectId, L2NpcTemplate template) {
    ...
    public class SpawnAttacker extends l2open.common.RunnableImpl {
        ...
        public SpawnAttacker(VarkaBaseInstance actor, int mobsID) {
            this.actor = actor;
            this.loc = actor.getLoc();
            this.mobsID = mobsID;
        }
