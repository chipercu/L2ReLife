...
public class VarkaGuardInstance extends L2MonsterInstance {

    public VarkaGuardInstance(int objectId, L2NpcTemplate template) {
        super(objectId, template);
        //this.setAI(new VarkaGuardAI(this));
    }
