...
На острове фантазий появляется НПСы для продажи ресурсов, кусков(до Ы) , рецептов (до Ы). НПСы появляется в районе базарчика (есть там место такое).
 Должны продавать определенное количество всем игрокам. Т.е. если кто то скупил все ресурсы, то другому уже не продаст. Если все продал в окне должно быть 'Я уже все продал... Приходи в следующий раз'
